...
/// A protocol for UICollectionViewCell that can be loaded with data conforming to the `CellDataProviding` protocol.
/// Implement this protocol in all cells that load data.
public protocol CollectionViewCellProtocol where Self: UICollectionViewCell {
